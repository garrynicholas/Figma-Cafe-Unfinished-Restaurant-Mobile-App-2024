import 'package:figmacafe/presentation/payment/payment_auth/alfa_auth.dart';
import 'package:flutter/material.dart';
import 'dart:math';

class PaymentAfmt extends StatefulWidget {
  final double amount;

  PaymentAfmt({required this.amount});

  @override
  _PaymentAfmtState createState() => _PaymentAfmtState();
}

class _PaymentAfmtState extends State<PaymentAfmt> {
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                SizedBox(height: 8.0),
                                Text(
                                  'Pergi langsung ke Alfamart untuk melakukan pembayaran.',
                                  style: TextStyle(
                                    fontSize: 14.0,
                                    color: Colors.black,
                                  ),
                    ...
                    ElevatedButton(
                      onPressed: () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => AlfaAuth(authenticationCode),
                          ),
                        );
                      },
