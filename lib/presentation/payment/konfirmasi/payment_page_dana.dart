import 'package:figmacafe/presentation/payment/payment_auth/dana_auth.dart';
import 'package:flutter/material.dart';
import 'dart:math';

class PaymentDana extends StatefulWidget {
  final double amount;

  PaymentDana({required this.amount});

  @override
  _PaymentDanaState createState() => _PaymentDanaState();
}

class _PaymentDanaState extends State<PaymentDana> {
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                SizedBox(height: 8.0),
                                Text(
                                  'Siapkan aplikasi Dana mu untuk melakukan pembayaran.',
                                  style: TextStyle(
                                    fontSize: 14.0,
                                    color: Colors.black,
                                  ),
                    ...
                    ElevatedButton(
                      onPressed: () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => DanaAuth(authenticationCode),
                          ),
                        );
                      },
