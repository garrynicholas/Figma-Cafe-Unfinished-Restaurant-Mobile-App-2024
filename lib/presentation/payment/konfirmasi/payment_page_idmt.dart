import 'package:figmacafe/presentation/payment/payment_auth/indo_auth.dart';
import 'package:flutter/material.dart';
import 'dart:math';

class PaymentIdmt extends StatefulWidget {
  final double amount;

  PaymentIdmt({required this.amount});

  @override
  _PaymentIdmtState createState() => _PaymentIdmtState();
}

class _PaymentIdmtState extends State<PaymentIdmt> {
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                SizedBox(height: 8.0),
                                Text(
                                  'Pergi langsung ke Indomaret untuk melakukan pembayaran.',
                                  style: TextStyle(
                                    fontSize: 14.0,
                                    color: Colors.black,
                                  ),
                    ...
                    ElevatedButton(
                      onPressed: () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => IndoAuth(authenticationCode),
                          ),
                        );
                      },
