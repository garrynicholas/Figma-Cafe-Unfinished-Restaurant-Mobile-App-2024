import 'package:figmacafe/presentation/payment/payment_auth/ovo_auth.dart';
...
class PaymentOVO extends StatefulWidget {
  ...
  PaymentOVO({required this.amount});
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                SizedBox(height: 8.0),
                                Text(
                                  'Siapkan aplikasi OVO mu untuk melakukan pembayaran.',
                                  style: TextStyle(
                                    fontSize: 14.0,
                                    color: Colors.black,
                                  ),
                    ...
                    ElevatedButton(
                      onPressed: () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => OVOAuth(authenticationCode),
                          ),
                        );
                      },
