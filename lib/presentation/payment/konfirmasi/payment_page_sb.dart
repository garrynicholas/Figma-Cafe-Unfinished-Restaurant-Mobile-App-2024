import 'package:figmacafe/presentation/payment/payment_auth/sb_auth.dart';
import 'package:flutter/material.dart';
import 'dart:math';

class PaymentSB extends StatefulWidget {
  final double amount;

  PaymentSB({required this.amount});

  @override
  _PaymentSBState createState() => _PaymentSBState();
}

class _PaymentSBState extends State<PaymentSB> {
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                SizedBox(height: 8.0),
                                Text(
                                  'Siapkan aplikasi SeaBank mu untuk melakukan pembayaran.',
                                  style: TextStyle(
                                    fontSize: 14.0,
                                    color: Colors.black,
                                  ),
                    ...
                    ElevatedButton(
                      onPressed: () {
                        ...
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) =>
                                SeaBankAuth(authenticationCode),
                          ),
                        );
                      },
