...
class IndoAuth extends StatelessWidget {
  final String authenticationCode;

  IndoAuth(this.authenticationCode);
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Column(
                          children: [
                            Image.asset(
                              'assets/images/indomaret.png', // Replace with the correct image path
                              width: 120.0,
                              height: 120.0,
                              fit: BoxFit.contain,
                            ),
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 8.0),
                            Text(
                              'Berikan kode ini ke Kasir Indomaret terdekat dalam waktu 24 jam untuk mengkonfirmasi pembelian Anda.',
                              style: TextStyle(
                                fontSize: 15.0,
