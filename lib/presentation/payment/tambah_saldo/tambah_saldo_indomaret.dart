import 'package:figmacafe/presentation/payment/konfirmasi/payment_page_idmt.dart';
import 'package:flutter/material.dart';

class TambahSaldoIndomaret extends StatefulWidget {
  @override
  _TambahSaldoIndomaretState createState() => _TambahSaldoIndomaretState();
}

class _TambahSaldoIndomaretState extends State<TambahSaldoIndomaret> {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        _buildLogoButton('assets/images/indomaret.png'),
                      ],
                    ),
                    ElevatedButton(
                      onPressed: () {
                        ...
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) =>
                                PaymentIdmt(amount: selectedAmount),
                          ),
                        );
                      },
