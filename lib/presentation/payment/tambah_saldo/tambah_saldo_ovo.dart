import 'package:figmacafe/presentation/payment/konfirmasi/payment_page_ovo.dart';
import 'package:flutter/material.dart';

class TambahSaldoOVO extends StatefulWidget {
  @override
  _TambahSaldoOVOState createState() => _TambahSaldoOVOState();
}

class _TambahSaldoOVOState extends State<TambahSaldoOVO> {
                      ...
                      ElevatedButton(
                        onPressed: () {
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (context) =>
                                  PaymentOVO(amount: selectedAmount),
                            ),
                          );
                        },
