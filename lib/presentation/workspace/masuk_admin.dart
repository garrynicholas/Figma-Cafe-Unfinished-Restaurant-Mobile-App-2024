...
import 'package:figmacafe/presentation/workspace/admin/admin_dashboard.dart';
...
class MasukManager extends StatefulWidget {
  const MasukManager({Key? key}) : super(key: key);

  @override
  _MasukManagerState createState() => _MasukManagerState();
}

class _MasukManagerState extends State<MasukManager> {
          ...
          child: Padding(
            ...
            child: Column(
              children: <Widget>[
                ...
                masukRuleButton(context, false, () async {
                  setState(() {
                    _emailError = false;
                  });
